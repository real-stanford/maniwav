...
from umi.real_world.multi_mic import MultiMicrophone
...
class UmiEnv:
    def __init__(self, 
        ...
        audio_recorder = list()
        for device_id in audio_device_id:
            audio_recorder.append(AudioRecorder(
                shm_manager=shm_manager,
        ...
        microphone = MultiMicrophone(  
            ...
            receive_latency=mic_obs_latency,
    ...
    @property
    def is_ready(self):
        return self.camera.is_ready and self.robot.is_ready and self.gripper.is_ready and self.microphone.is_ready
    ...
    def get_obs(self) -> dict:
        ...
        if self.last_microphone_data:
            ...
            if self.noise_cancellation:
                ...
                reduced_audio = nr.reduce_noise(y=raw_audio, sr=48000, thresh_n_mult_nonstationary=1, stationary=False)
                mic_obs['mic_0'] = reduced_audio.reshape(audio_block.shape[0], audio_block.shape[1])
            # assert mic_obs['mic_0'].shape == (120, 800)
    ...
    def start_episode(self, start_time=None):
        ...
        self.microphone.start_recording(audio_path=audio_paths, start_time=start_time)
